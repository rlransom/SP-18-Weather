###############################################################
##Hourly Weather Data for 2018 SP Growing Season - Clinton
###############################################################
...
##Export tidied data
write_csv(Data, path = "Exported_Data/Tidy_Clinton_Weather_2018.csv")
...
ggplot(Data, aes(x=Air_Temp_DB))+
  ...
  ggtitle("2018 Clinton Temperature Histogram")+
...
ggplot(Data_with_weeks, aes(x=Week, y=Air_Temp_DB, group=Week))+
  geom_boxplot()+
  ggtitle("2018 Clinton Temperature Boxplot")+
...
ggplot(Data, aes(x=Soil_Moisture_Avg))+
  ...
  ggtitle("2018 Clinton Soil Moisture Histogram")+
...
ggplot(Data_with_weeks, aes(x=Week, y=Soil_Moisture_Avg, group=Week))+
  geom_boxplot()+
  ggtitle("2018 Clinton Weekly Mean Soil Moisture Boxplots")+
  xlab("Week Since Planting")+
